...
class ColorResources {
  static const kPrimaryColor = Color(0xFF00AE56);
  static const kPrimaryLightColor = Color(0xFFF1E6FF);

  static const windowBackground = Color(0xFFE0E0E0);
  static const kGreenSemiTransparent = Color(0xFFCBDCD6);
  static const kSemiTransparent = Color(0x6600AE56);
...
*/
  ...
  static const Color fandango = Color(0xffad277c);
  ...
  static const Color tableRowColor = Color(0xffe7e9eb);
