...
abstract class AppColors {
  ...
  static const MaterialColor kToDark = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xFF00AE56), //10%
      100: Color(0xFF00AE56), //20%
      200: Color(0xFF00AE56), //30%
      300: Color(0xFF00AE56), //40%
      400: Color(0xFF00AE56), //50%
      500: Color(0xFF00AE56), //60%
      600: Color(0xFF00AE56), //70%
      700: Color(0xFF00AE56), //80%
      800: Color(0xFF00AE56), //90%
      900: Color(0xFF00AE56), //100%
    },
  );
}
